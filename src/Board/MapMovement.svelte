<script context="module">
  export const NEIGHBOURING_STATES = {'Alaska':['Northwest Territory', 'Alberta', 'Kamchatka'],
            ...
            'Western Europe':['Britain', 'North Africa', 'Southern Europe', 'Northern Europe'],
            'Northern Europe':['Western Europe', 'Southern Europe', 'Ukraine', 'Britain', 'Scandinavia'],
  ...
  export const COUNTRY_CONTINENT = {
            'Alaska':'N. America',
            'Northwest Territory':'N. America',
            'Alberta':'N. America',
            'Ontario':'N. America',
            'Quebec':'N. America',
            'Western United States':'N. America',
            'Eastern United States':'N. America',
            'Central America':'N. America',
            'Greenland':'N. America',
            'Afghanistan':'Asia',
            'Middle East':'Asia',
            'India':'Asia',
